		...
		if(cmd.getName().equalsIgnoreCase("teleport")) {
			...
			if(args.length == 2) {
				...
				if(p.getName().equals(target1.getName())) {
					...
					ChatUtils.message(target2, ChatColor.AQUA + p.getName() + ChatColor.GOLD + " has teleported to you.");
					return true;
				}
				if(p.getName().equals(target2.getName())) {
					ChatUtils.message(p, "You have teleported to: " + ChatColor.AQUA + target2.getName() + ChatColor.GOLD + ".");
					ChatUtils.message(target2, ChatColor.AQUA + target1.getName() + ChatColor.GOLD + " has teleported to you.");
					return true;
				}
				...
				ChatUtils.message(target1, "You have been teleported to: " + ChatColor.AQUA + target2.getName() + ChatColor.GOLD + " by: " + ChatColor.AQUA + p.getName() + ChatColor.GOLD + ".");
				ChatUtils.message(target2, ChatColor.AQUA + target1.getName() + ChatColor.GOLD + " has been teleported to you by: " + ChatColor.AQUA + p.getName() + ChatColor.GOLD + ".");
				return true;
			}
